...
def test_gemini():
    ...
    try:
        ...
        logger.info("   Tip: Make sure you're using a valid Gemini API key from https://makersuite.google.com/app/apikey")
        return False
...
def test_openai():
    ...
    try:
        ...
        logger.info("   Tip: Check your OpenAI API key at https://platform.openai.com/api-keys")
        return False
...
def test_pinecone():
    ...
    try:
        ...
        logger.info(f"✅ Pinecone API: Connected (environment: {settings.pinecone_environment})")
