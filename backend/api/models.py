...
class QueryRequest(BaseModel):
    ...
    code_type: Optional[str] = Field(None, description="Filter by code type (function, class, etc.)")
    top_k: Optional[int] = Field(5, description="Number of results to return")
    include_context: Optional[bool] = Field(True, description="Include full context in response")
